...
public class JavaEmail {
    ...
    /*public static void main(String[] args) throws Exception {
        ...
        int res=sendEmail("smtp.qq.com", "9856943xx@qq.com", "pwvsvgpinursbeae", "9856943xx@qq.com", new String[]{
                "9856943xx@qq.com" //这里就是一系列的收件人的邮箱了
        }, "祝福", "爱你么么哒！","text/html;charset=utf-8");
